...
public class NavigateToPortalesRegulatoriosDashboard implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitUntil.the(PORTALES_REGULATORIOS_DASHBOARD, WebElementStateMatchers.isVisible())
                        .forNoMoreThan(10).seconds(),

                // Hacer clic en dashboard
                Click.on(PORTALES_REGULATORIOS_DASHBOARD)
        );
    }

    public static NavigateToPortalesRegulatoriosDashboard navigate() {
        return instrumented(NavigateToPortalesRegulatoriosDashboard.class);
    }
}